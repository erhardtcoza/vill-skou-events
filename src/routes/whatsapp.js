...
/** Generic template sender (kept backward compatible, now with optional template override). */
export async function sendWhatsAppTemplate(env, toMsisdn, bodyText, lang, templateNameOverride) {
  const templateName = templateNameOverride || env.WHATSAPP_TEMPLATE_NAME || "ticket_delivery";
